package com.example.xtanctrlsystem.security.common.handler;
...
public class HttpHandler {
    ...
    public <T> void printServerResponseToWeb(String str, int status) throws Exception {
